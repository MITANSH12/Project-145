...
def showLicense():
    varId = 19827198349
    varName = "Winnie the Pooh"
    VarDOB = "21 August 1921"
    VarPin = 451478
    VarAdd = "Disneyland , Honk Kong"
    VarVehicleType = "Two Four"
    label_id["text"] = varId
    label_name["text"] = varName
    label_dob["text"] = VarDOB
    label_pin["text"] = VarPin
    label_address["text"]= VarAdd
    label_vehicle_type["text"] = VarVehicleType
